...
pub const fn get_default_keymap() -> [[[KeyAction; COL]; ROW]; NUM_LAYER] {
    [
        ...
        layer!([
            [k!(No),            wm!(Equal, SHIFT), wm!(Kc3, SHIFT), wm!(Kc4, SHIFT),  k!(No),                   k!(Equal),        wm!(Kc0, SHIFT), wm!(Kc9, SHIFT), k!(No),        k!(No)],
            ...
            [k!(No),            k!(No),            k!(No),          k!(No),           a!(Transparent),          a!(No),           k!(No),          k!(No),          k!(No),        k!(No)]
        ]),
        layer!([
