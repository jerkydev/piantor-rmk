...
pub const fn get_default_keymap() -> [[[KeyAction; COL]; ROW]; NUM_LAYER] {
    [
        layer!([
            ...
            [k!(No),       k!(No),      k!(No),        k!(Space),   mo!(3),         mo!(1), mo!(2),      k!(No),        k!(No),      k!(No)]
        ]),
        layer!([
            [k!(No),            wm!(Equal, SHIFT), wm!(Kc3, SHIFT), wm!(Kc4, SHIFT),  k!(No),                   k!(Equal),        wm!(Kc0, SHIFT), wm!(Kc9, SHIFT), k!(BrightnessDown), k!(BrightnessUp)],
            ...
            [k!(No),            k!(No),            k!(No),          k!(No),           a!(No),                   a!(Transparent),  k!(No),          k!(No),          k!(No),             k!(No)]
        ]),
        layer!([
            ...
            [k!(F6),             k!(F7),             k!(F8),             k!(F9),           k!(F10),                 k!(Home),   k!(Tab),         k!(PageDown), k!(End),       k!(No)],
            [k!(No),             k!(No),             k!(Bootloader),     k!(F11),          k!(F12),                 k!(No),     a!(Transparent), k!(No),       k!(No),        k!(No)]
        ]),
        layer!([
            ...
            [k!(No),            k!(No),            k!(No),                  k!(No),                   a!(Transparent),          k!(Backslash),     wm!(Kc2, SHIFT),  k!(No),          k!(No),        k!(No)]
        ]),
        // layer!([
